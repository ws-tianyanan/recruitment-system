...
<body>
	...
	<div class="success_content">
		...
		<div class="success_right">
			<p class="green16">需要先填写猎头信息，才能进行猎头相关工作哟！</p>
			<p>快快选择以下任意一种方式填写猎头信息，去开始猎聘工作吧！</p>
			<p>
			<!-- /recruitment-system/WebContent/headhunting_user/jsp/addHeadhuntingInfo.jsp -->
				<a href="headhunting_user/jsp/addHeadhuntingInfo.jsp">
				<span class="tn-button">填写猎头信息</span></a>
