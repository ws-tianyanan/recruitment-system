...
<body>
	...
	<div class="resume_con">
		...
		<div class="user_operate">
			<ul style="float: left">
				<li> <a href="ResumeServlet?type=select">我的猎头信息</a></li>
		...
		<div class="resume_main">
			...
			<div class="resume_left">
				...
				<div class="all_resume" style="text-align: center;" align="center">
					<!--------------------- 猎头基本信息添加 ------------------------->
					<form action="headhuntingServlet?type=addHeadhuntingInfo" method="post" onsubmit="return validate();">
