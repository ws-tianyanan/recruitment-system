		...
		<div class="resume_main">
			...
			<div class="resume_left" style="width: 995px">
				...
				<div class="all_resume" style="text-align: center;" align="center">
					<!--------------------- 企业基本信息添加 ------------------------->
					<form action="CompanyServlet?type=addEnterpriseInfo" method="post"
						...
						<div class="table_style" style="margin-left: 150px;">
							...
							<table width="650" border="0" cellpadding="3" cellspacing="1"
								...
								<tr>
									...
									<td bgcolor="#F8F8F8" align="left"><input
										name="companyRegisterTime" type="text"
										id="companyRegisterTime" onclick="SelectDate(this)"
										readonly="readonly" />&nbsp;&nbsp;</td>
									<td width="110" align="right" bgcolor="#F8F8F8">注册资本(万元)：</td>
									<td bgcolor="#F8F8F8" align="left"><input
										name="companyRegisterCapital" type="text"
										id="companyRegisterCapital" /></td>
								</tr>
							</table>
							<div class="he"></div>
							<table width="650" border="0" cellpadding="3" cellspacing="1"
							...
							<table width="650" border="0" cellpadding="3" cellspacing="1"
								...
								<tr>
									...
									<td bgcolor="#F8F8F8" align="left"><textarea rows="10"
											cols="55" name="companyBrief"></textarea></td>
								</tr>
							</table>
							<div class="he"></div>
							<table width="650" border="0" cellpadding="3" cellspacing="1"
								...
								<tr>
									...
									<td bgcolor="#F8F8F8" align="left"><input
										name="companyPic" id="companyPic" type="file" class="dfinput" />
							...
							<table width="650" border="0" cellpadding="3" cellspacing="1"
								...
								<td bgcolor="#F8F8F8" align="left"><select
									name="companyState">
