...
<%@ page
	import="com.itoffer.dao.JobDAO,com.itoffer.bean.Job,com.itoffer.bean.User"%>
<%
		...
		<div class="resume_main">
			...
			<div class="resume_left" style="width: 995px">
				<div class="resume_title">
					<div style="float: left">职位信息修改</div>
				</div>
				<div class="all_resume" style="text-align: center;" align="center">
					<!--------------------- 职位基本信息修改 ------------------------->
					<form action="JobServlet?type=updateJobInfo&jobId=<%=jobId%>" method="post" onsubmit="return validate();">
						<div class="table_style" style="margin-left:150px;">
							...
							<table width="650" border="0" cellpadding="3" cellspacing="1"
								...
								<td width="110" align="right" bgcolor="#F8F8F8">职位薪资：</td>
									<td bgcolor="#F8F8F8" align="left"><input type="text"
										name="jobSalary" value="<%=job.getJobSalary()%>">&nbsp;&nbsp;</td>
									<td width="110" align="right" bgcolor="#F8F8F8">招聘人数：</td>
									<td bgcolor="#F8F8F8" align="left"><input type="text"
										name="jobHiringnum" value="<%=job.getJobHiringnum()%>"></td>
								</tr>
							</table>
							<div class="he"></div>
							<table width="650" border="0" cellpadding="3" cellspacing="1"
								...
								<tr>
									...
									<td bgcolor="#F8F8F8" align="left"><input type="text"
										name="jobAgeRequirements" value="<%=job.getJobAgeRequirements()%>">&nbsp;&nbsp;</td>
										<td width="110" align="right" bgcolor="#F8F8F8">学历要求：</td>
									<td bgcolor="#F8F8F8" align="left"><input type="text"
										name="jobEducationRequirements" value="<%=job.getJobEducationRequirements()%>"></td>
								</tr>
							</table>
							<div class="he"></div>
							<table width="650" border="0" cellpadding="3" cellspacing="1"
								...
								<td width="110" align="right" bgcolor="#F8F8F8">性别要求：</td>
									<td bgcolor="#F8F8F8" align="left"><input type="text" id="jobSexRequirements"
										name="jobSexRequirements" value="<%=job.getJobSexRequirements()%>"><font style="color: red">*</font>&nbsp;</td>
									<td width="110" align="right" bgcolor="#F8F8F8">外语要求：</td>
									<td bgcolor="#F8F8F8" align="left"><input type="text"
										name="jobForeignLanguages" value="<%=job.getJobForeignLanguages()%>"></td>
								</tr>
							</table>
							<div class="he"></div>
							...
							<table width="650" border="0" cellpadding="3" cellspacing="1"
								...
								<tr>
									...
									<textarea rows="10" cols="70" name="jobDesc"> <%=job.getJobDesc()%></textarea></td>
								</tr>
							</table>
							<div class="he"></div>
							<table width="650" border="0" cellpadding="3" cellspacing="1"
