...
<body>
	...
	<div class="success_content">
		...
		<div class="success_right">
			<p class="green16">需要先填写企业信息，才能进行招聘哟！</p>
			<p>快快选择以下任意一种方式完善企业信息，去进行招聘吧！</p>
			<p>
			<!-- /recruitment-system/WebContent/enterprise_user/jsp/addEnterprise.jsp -->
				<a href="enterprise_user/jsp/addEnterprise.jsp">
				<span class="tn-button">填写企业信息</span></a>
