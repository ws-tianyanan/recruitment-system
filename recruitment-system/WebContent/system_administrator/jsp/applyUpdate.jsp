 ...
 <div class="usual">
  ...
  <ul class="forminfo">
	...
	<li> <p>企业简介&nbsp;（不超过1000字）：</p></br>
	 <textarea name="companyBrief" id="companyBrief" cols="50" rows="10" type="text" class="ckeditor" >
	...
	<li> <label>显示排序：</label>
	 <input name="companySort" value='<%=company.getCompanySort() %>' id="companySort"
	 type="text" class="dfinput" style="width:518px;"/>
	</li>
	<li> <label>宣传图片：</label>
	 <img src="${pageContext.servletContext.contextPath }/images/company/<%=company.getCompanyPic() %>"><br>
