...
<div class="tn-grid" align="center">
   <div class="bottomban">
    ...
    <a href="CompanyServlet?type=selectById&id=${requestScope.company.companyId }"> 
    ...
    <div class="it-main">
      ...
      <div class="job">
        ...
        <div class="it-post-count">
          ...
          <ul class="tn-text-note" style="margin:10px 40px 40px 0px;width: 150px;color: #999">
            ...
            <span class="tn-icon it-icon-time"></span>
             <span class="tn-icon-text">
              ...
              <c:if test="${requestScope.job.jobState == 2 }">已结束</c:if>
             </span>
            </span></li>
            <li class="jobli"><span class="tn-explain-icon">
        ...
        <div class="clear"> </div>
        <div class="it-post-text" style="margin: 0px 10px"><br>
        <h2>职位描述</h2><div style="height: 10px"></div>
          <p>${requestScope.job.jobDesc }</p>
        </div>
        <div class="btn_bot"> 
        <a class="tn-button-secondary" href="CompanyServlet?type=selectById&id=${requestScope.company.companyId }"> 
        <span style="color:#751f98"  class="tn-button-text">查看公司信息</span> 
        </a> 
